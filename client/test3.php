...
$votesQuery = "SELECT id FROM votes WHERE user_id = '" . $_SESSION['user_id'] . "'"; // Assuming user_id is stored in session
...
function castVote(event, candidateId) {
    ...
    .then(data => {
        if (data.success) {
            ...
            // Optionally, you can redirect to the next page after voting
